# Operator Quickstart — Manufacture of sports goods

Shortest path from clone to a verified local dry-run for **ISIC 3230** (`cloud-itonami-isic-3230`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3230.git
cd cloud-itonami-isic-3230
```
...
- Blueprint governor key: `sports-goods-plant-operations-governor`
- Likely source path: `sportsgoodsmfg.governor.cljc`
