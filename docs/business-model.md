# Business Model: Manufacture of sports goods
...
## Classification
- Repository: `cloud-itonami-isic-3230` ([github.com/cloud-itonami/cloud-itonami-isic-3230](https://github.com/cloud-itonami/cloud-itonami-isic-3230))
- ISIC Rev.5: `3230` — Manufacture of sports goods
- Domain: `:sports-goods/manufacturing`
- Social impact: :worker-safety :materials-safety :consumer-protection
- Actor: `:sports-goods-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :sports-goods/manufacturing — who wants
...
One managed tenant (:sports-goods/manufacturing):
...
- Do not bypass the `:sports-goods-plant-operations-governor` for production decisions.
