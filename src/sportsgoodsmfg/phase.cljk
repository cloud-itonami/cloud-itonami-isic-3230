(ns sportsgoodsmfg.phase
  "Phase 0->3 staged rollout for the sports-goods plant-operations
  coordination actor.
  ...
  consequence (a molding/assembly/finishing-equipment maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `sportsgoodsmfg.governor`'s `actuate-equipment-blocked-violations`
...
(defn verdict->disposition
  "Map a Sports Goods Plant Operations Governor verdict to a base
